...
alerta = function (txt, titulo, txtDefault, alto = "auto", ancho = "300px", textbox, txtComodin, idComodin, clickComodin = "", idDefault = "closeBtn", idcont = "modalContainer") {
    var d = document, destruir = function () { d.getElementsByTagName("body")[0].removeChild(d.getElementById(idcont)); d.getElementById('form1').style.opacity = 1; };
    if (d.getElementById(idcont)) return;
    var contenedor = d.getElementsByTagName("body")[0].appendChild(d.createElement("div")); contenedor.id = idcont; d.getElementById('form1').style.opacity = 0.5;
    ...
    cuadro.style = "position: relative; min-height: " + alto + "; height: auto; width: " + ancho + "; margin-top: 100px; border: 2px solid #000; border-radius: 10px; background-color: " + sessionStorage.getItem('alerta1')+"; text-align: center;";
    ...
    var msg = enc.appendChild(d.createElement("p")); msg.innerHTML = txt; msg.style = "font: 15px verdana,arial; height: auto; padding: 10px 30px; text-align: center; background-color: " + sessionStorage.getItem('alerta2') +";";
